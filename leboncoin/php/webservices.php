...
//	include "connection_BDD.php";
	...
	function search_mes_articles($bdd, $id){	
...
function insert_article($bdd, $id, $type, $ressource, $titre, $region, $departement, $ville, $voie, $prix, $description, $photo){
	
	$req_article = 'INSERT INTO article 
	(titre, description, voie, prix, date_publication, date_peremption, ville, departement, region, ressource, id_statistique, type, photo,id_utilisateur) 
	VALUES (:titre, :description, :voie, :prix, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 15 DAY), :ville, :departement, :region, :ressource, 1, :type, :photo,:id_utilisateur)';
	...
	try{
		...
		$statement->bindValue(':id_utilisateur', $id);
		$statement->execute();
	}
	catch(PDOException $e){
...
function update_article($bdd, $id_article, $type, $ressource, $titre, $region, $departement, $ville, $voie, $prix, $description,$photo){
