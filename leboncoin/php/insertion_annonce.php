		...
		<?php
			...
			if ( isset($_SESSION['id'])){
				if (isset($_POST['titre']) && $_POST['titre']!='' &&
					...
					insert_article($bdd, $_SESSION['id'], $_POST['type'], $_POST['ressource'], $_POST['titre'], $_POST['region'], $_POST['departement'], $_POST['ville'], $_POST['voie'], $_POST['prix'], $_POST['description'], $_POST['photo']);
